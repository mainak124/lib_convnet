...
bld.output_dir = '~/lenet_multi_input/lib_convnet/RIFFA_BUILDER/user/Output'
bld.verilog_src_file = '~/lenet_multi_input/lib_convnet/convnet_cpp/solution1/impl/ip/hdl/verilog/inference.v'
