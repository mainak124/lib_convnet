; ModuleID = 'C:/Users/Vikasini/Desktop/EmbeddedImageProccessing/RIFFA_BUILDER/user/HLS/hls_loopback/hls_loopback/solution1/.autopilot/db/a.g.1.bc'
...
codeRepl:
  ...
  call void @llvm.dbg.value(metadata !{i32* %IN}, i64 0, metadata !2667), !dbg !2668 ; [debug line = 2:21] [debug variable = IN]
  call void @llvm.dbg.value(metadata !{i32* %OUT}, i64 0, metadata !2669), !dbg !2670 ; [debug line = 2:37] [debug variable = OUT]
  call void (...)* @_ssdm_SpecArrayDimSize(i32* %IN, i32 65536) nounwind, !dbg !2671 ; [debug line = 2:48]
  call void (...)* @_ssdm_SpecArrayDimSize(i32* %OUT, i32 65536) nounwind, !dbg !2673 ; [debug line = 2:80]
  call void (...)* @_ssdm_op_SpecInterface(i32* %IN, i8* getelementptr inbounds ([5 x i8]* @.str, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !2674 ; [debug line = 3:1]
  call void (...)* @_ssdm_op_SpecInterface(i32* %OUT, i8* getelementptr inbounds ([5 x i8]* @.str, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !2675 ; [debug line = 4:1]
  call void (...)* @_ssdm_op_SpecDataflowPipeline(i32 -1, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !2676 ; [debug line = 6:1]
  br label %0

; <label>:0                                       ; preds = %1, %codeRepl
  %i.0.i = phi i32 [ 0, %codeRepl ], [ %i, %1 ]   ; [#uses=3 type=i32]
  %exitcond.i = icmp eq i32 %i.0.i, 65536, !dbg !2677 ; [#uses=1 type=i1] [debug line = 8:12]
  br i1 %exitcond.i, label %Loopback_.exit, label %1, !dbg !2677 ; [debug line = 8:12]

; <label>:1                                       ; preds = %0
  %tmp = sext i32 %i.0.i to i64, !dbg !2679       ; [#uses=2 type=i64] [debug line = 10:1]
  %IN.addr = getelementptr inbounds i32* %IN, i64 %tmp, !dbg !2679 ; [#uses=1 type=i32*] [debug line = 10:1]
  %IN.load = load i32* %IN.addr, align 4, !dbg !2679 ; [#uses=2 type=i32] [debug line = 10:1]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %IN.load) nounwind
  %OUT.addr = getelementptr inbounds i32* %OUT, i64 %tmp, !dbg !2679 ; [#uses=1 type=i32*] [debug line = 10:1]
  store i32 %IN.load, i32* %OUT.addr, align 4, !dbg !2679 ; [debug line = 10:1]
  %i = add nsw i32 %i.0.i, 1, !dbg !2681          ; [#uses=1 type=i32] [debug line = 8:21]
  call void @llvm.dbg.value(metadata !{i32 %i}, i64 0, metadata !2682) nounwind, !dbg !2681 ; [debug line = 8:21] [debug variable = i]
  br label %0, !dbg !2681                         ; [debug line = 8:21]

Loopback_.exit:                                   ; preds = %0
  ret void, !dbg !2683                            ; [debug line = 14:1]
}
...
!869 = metadata !{i32 786478, i32 0, metadata !870, metadata !"Loopback", metadata !"Loopback", metadata !"_Z8LoopbackPiS_", metadata !870, i32 2, metadata !871, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void (i32*, i32*)* @Loopback, null, null, metadata !87, i32 2} ; [ DW_TAG_subprogram ]
...
!2667 = metadata !{i32 786689, metadata !869, metadata !"IN", metadata !870, i32 16777218, metadata !873, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2668 = metadata !{i32 2, i32 21, metadata !869, null}
!2669 = metadata !{i32 786689, metadata !869, metadata !"OUT", metadata !870, i32 33554434, metadata !873, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2670 = metadata !{i32 2, i32 37, metadata !869, null}
!2671 = metadata !{i32 2, i32 48, metadata !2672, null}
!2672 = metadata !{i32 786443, metadata !869, i32 2, i32 47, metadata !870, i32 0} ; [ DW_TAG_lexical_block ]
!2673 = metadata !{i32 2, i32 80, metadata !2672, null}
!2674 = metadata !{i32 3, i32 1, metadata !2672, null}
!2675 = metadata !{i32 4, i32 1, metadata !2672, null}
!2676 = metadata !{i32 6, i32 1, metadata !2672, null}
!2677 = metadata !{i32 8, i32 12, metadata !2678, null}
!2678 = metadata !{i32 786443, metadata !2672, i32 8, i32 1, metadata !870, i32 1} ; [ DW_TAG_lexical_block ]
!2679 = metadata !{i32 10, i32 1, metadata !2680, null}
!2680 = metadata !{i32 786443, metadata !2678, i32 8, i32 26, metadata !870, i32 2} ; [ DW_TAG_lexical_block ]
!2681 = metadata !{i32 8, i32 21, metadata !2678, null}
!2682 = metadata !{i32 786688, metadata !2678, metadata !"i", metadata !870, i32 8, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2683 = metadata !{i32 14, i32 1, metadata !2672, null}
