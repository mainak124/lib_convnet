...
HD_PWD='/home/sakthi/lib_convnet/RIFFA_BUILDER/user/Output/FPGA_PRJ/prj/VC709_Gen3x4If128.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VC709_Gen3x4If128.vds -m64 -mode batch -messageDb vivado.pb -notrace -source VC709_Gen3x4If128.tcl
