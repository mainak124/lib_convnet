...
int main(int argc, char** argv) {
    ...
    GET_TIME_VAL(0);
    run_time_ms = inference(fpga, ap_rst, &inputImage_address0, &inputImage_ce0, &inputImage_d0, inputImage_q0, &inputImage_we0, &Filter1_address0, &Filter1_ce0, &Filter1_d0, Filter1_q0, &Filter1_we0, &bias1_address0, &bias1_ce0, &bias1_d0, bias1_q0, &bias1_we0, &Filter2_address0, &Filter2_ce0, &Filter2_d0, Filter2_q0, &Filter2_we0, &bias2_address0, &bias2_ce0, &bias2_d0, bias2_q0, &bias2_we0, &Filter3_address0, &Filter3_ce0, &Filter3_d0, Filter3_q0, &Filter3_we0, &bias3_address0, &bias3_ce0, &bias3_d0, bias3_q0, &bias3_we0, &fcWeight_address0, &fcWeight_ce0, &fcWeight_d0, fcWeight_q0, &fcWeight_we0, &fcBias_address0, &fcBias_ce0, &fcBias_d0, fcBias_q0, &fcBias_we0, &smWeight_address0, &smWeight_ce0, &smWeight_d0, smWeight_q0, &smWeight_we0, &smBias_address0, &smBias_ce0, &smBias_d0, smBias_q0, &smBias_we0, &outDigit, &outDigit_ap_vld, DEBUG_LEVEL);
