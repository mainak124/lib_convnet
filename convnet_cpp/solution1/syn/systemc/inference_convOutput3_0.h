...
#ifndef _inference_convOutput3_0_H_
#define _inference_convOutput3_0_H_

#include <systemc>
#include <iostream>
#include <fstream>

#include "inference_convOutput3_0_memcore.h"

SC_MODULE(inference_convOutput3_0) {
...
protected:
    ...
    inference_convOutput3_0_memcore* inference_convOutput3_0_memcore_U;
...
public:
    ...
    SC_CTOR(inference_convOutput3_0) : m_trace_file(0) {
        SC_METHOD(proc_memcore_addr);
        sensitive << i_address0 << t_address0 << iptr << tptr;

        inference_convOutput3_0_memcore_U = new inference_convOutput3_0_memcore("inference_convOutput3_0_memcore_U");
        inference_convOutput3_0_memcore_U->clk      ( clk );
        inference_convOutput3_0_memcore_U->reset    ( reset );
        inference_convOutput3_0_memcore_U->ce0      ( i_ce0 );
        inference_convOutput3_0_memcore_U->we0      ( i_we0 );
        inference_convOutput3_0_memcore_U->address0 ( memcore_iaddr );
        inference_convOutput3_0_memcore_U->d0       ( i_d0 );
        inference_convOutput3_0_memcore_U->q0       ( i_q0 );

        inference_convOutput3_0_memcore_U->ce1      ( t_ce0 );
        inference_convOutput3_0_memcore_U->we1      ( t_we0 );
        inference_convOutput3_0_memcore_U->address1 ( memcore_taddr );
        inference_convOutput3_0_memcore_U->d1       ( t_d0 );
        inference_convOutput3_0_memcore_U->q1       ( t_q0 );
        ...
        if (dump_vcd) {
            m_trace_file = sc_create_vcd_trace_file( "inference_convOutput3_0.trace");
            // ports
