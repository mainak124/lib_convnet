...
#ifndef FIFO_inference_fcIn_0_34_HH_
#define FIFO_inference_fcIn_0_34_HH_

#include <systemc>
using namespace std;
SC_MODULE(FIFO_inference_fcIn_0_34) {
    static const unsigned int DATA_WIDTH = 32;
    static const unsigned int ADDR_WIDTH = 2;
    static const unsigned int FIFO_inference_fcIn_0_34_depth = 3;
    ...
    sc_core::sc_signal< sc_dt::sc_lv<DATA_WIDTH> >  mStorage[FIFO_inference_fcIn_0_34_depth];
    ...
    SC_CTOR(FIFO_inference_fcIn_0_34) : mTrace(0) {
        ...
        SC_METHOD(proc_dout);
        sensitive << mOutPtr;
        for (unsigned i = 0; i < FIFO_inference_fcIn_0_34_depth; i++) {
        ...
        if (reset.read() == sc_dt::SC_LOGIC_1) {
            ...
            if (if_read_ce.read() == sc_dt::SC_LOGIC_1
               ...
               && internal_empty_n.read() == sc_dt::SC_LOGIC_1) {
                ...
                if (mOutPtr.read().to_uint() == (FIFO_inference_fcIn_0_34_depth-1)) {
                    ptr = 0;
                ...
                assert(ptr.to_uint() < FIFO_inference_fcIn_0_34_depth);
                mOutPtr.write(ptr);
            }
            if (if_write_ce.read() == sc_dt::SC_LOGIC_1
                ...
                if (ptr.to_uint() == (FIFO_inference_fcIn_0_34_depth-1)) {
                    ptr = 0;
                    mFlag_nEF_hint.write(~mFlag_nEF_hint.read());
                } else {
                    ptr++;
    ...
    void proc_dout() {
        ...
        if (ptr.to_uint() > FIFO_inference_fcIn_0_34_depth) {
...
#endif //FIFO_inference_fcIn_0_34_HH_
