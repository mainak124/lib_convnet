...
entity inference_conv2d_2_f2_3_3_0_rom is 
    generic(
             dwidth     : integer := 32; 
             awidth     : integer := 4; 
             mem_size    : integer := 16
...
architecture rtl of inference_conv2d_2_f2_3_3_0_rom is 
...
entity inference_conv2d_2_f2_3_3_0 is
    generic (
...
architecture arch of inference_conv2d_2_f2_3_3_0 is
    component inference_conv2d_2_f2_3_3_0_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    inference_conv2d_2_f2_3_3_0_rom_U :  component inference_conv2d_2_f2_3_3_0_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
