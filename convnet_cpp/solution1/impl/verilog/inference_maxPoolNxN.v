...
reg    ap_sig_bdd_25;
wire   [5:0] tmp_29_fu_215_p2;
reg   [5:0] tmp_29_reg_492;
reg    ap_sig_cseq_ST_st2_fsm_1;
reg    ap_sig_bdd_50;
wire   [0:0] tmp_fu_183_p2;
wire   [9:0] tmp_42_cast_fu_246_p3;
reg   [9:0] tmp_42_cast_reg_500;
reg    ap_sig_cseq_ST_st3_fsm_2;
reg    ap_sig_bdd_64;
wire   [0:0] tmp_2_fu_221_p2;
wire   [3:0] in_r_idx_2_fu_254_p2;
...
wire   [3:0] in_c_idx_2_fu_290_p2;
wire   [1:0] r_idx_2_fu_306_p2;
reg   [1:0] r_idx_2_reg_536;
reg    ap_sig_cseq_ST_st5_fsm_4;
reg    ap_sig_bdd_100;
wire   [7:0] tmp_35_fu_342_p2;
reg   [7:0] tmp_35_reg_541;
wire   [0:0] exitcond1_fu_300_p2;
wire   [1:0] c_idx_2_fu_358_p2;
reg   [1:0] c_idx_2_reg_549;
...
wire   [7:0] tmp_36_fu_374_p2;
wire   [11:0] tmp_49_cast_fu_379_p3;
wire   [11:0] tmp_37_fu_387_p2;
wire   [31:0] out_4_to_int_fu_397_p1;
wire   [31:0] out_1_to_int_fu_415_p1;
wire   [7:0] tmp_17_fu_401_p4;
wire   [22:0] tmp_38_fu_411_p1;
wire   [0:0] notrhs_fu_439_p2;
wire   [0:0] notlhs_fu_433_p2;
wire   [7:0] tmp_19_fu_419_p4;
wire   [22:0] tmp_39_fu_429_p1;
wire   [0:0] notrhs7_fu_457_p2;
wire   [0:0] notlhs6_fu_451_p2;
wire   [0:0] tmp_21_fu_445_p2;
wire   [0:0] tmp_22_fu_463_p2;
wire   [0:0] tmp_23_fu_469_p2;
wire   [0:0] tmp_24_fu_177_p2;
wire   [0:0] tmp_25_fu_475_p2;
wire   [4:0] tmp_24_fu_177_opcode;
reg   [6:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (((ap_const_logic_1 == ap_sig_cseq_ST_st4_fsm_3) & (ap_const_lv1_0 == exitcond2_fu_260_p2))) begin
        out_feature_addr_reg_523 <= tmp_43_cast_fu_285_p1;
...
always @ (posedge ap_clk) begin
    if (((ap_const_logic_1 == ap_sig_cseq_ST_st5_fsm_4) & (ap_const_lv1_0 == exitcond1_fu_300_p2))) begin
        tmp_35_reg_541[7 : 1] <= tmp_35_fu_342_p2[7 : 1];
    end
end

always @ (posedge ap_clk) begin
    if (((ap_const_logic_1 == ap_sig_cseq_ST_st3_fsm_2) & ~(ap_const_lv1_0 == tmp_2_fu_221_p2))) begin
        tmp_42_cast_reg_500[9 : 4] <= tmp_42_cast_fu_246_p3[9 : 4];
    end
end
...
assign c_idx_2_fu_358_p2 = (c_idx_reg_166 + ap_const_lv2_1);
...
assign in_c_idx_2_fu_290_p2 = (in_c_idx_reg_107 + ap_const_lv4_2);

assign in_ch_idx_fu_266_p2 = (out_ch_idx_reg_119 + ap_const_lv5_1);

assign in_r_idx_2_fu_254_p2 = (in_r_idx_reg_95 + ap_const_lv4_2);

assign notlhs6_fu_451_p2 = (tmp_19_fu_419_p4 != ap_const_lv8_FF? 1'b1: 1'b0);

assign notlhs_fu_433_p2 = (tmp_17_fu_401_p4 != ap_const_lv8_FF? 1'b1: 1'b0);

assign notrhs7_fu_457_p2 = (tmp_39_fu_429_p1 == ap_const_lv23_0? 1'b1: 1'b0);

assign notrhs_fu_439_p2 = (tmp_38_fu_411_p1 == ap_const_lv23_0? 1'b1: 1'b0);

assign out_1_to_int_fu_415_p1 = out_1_reg_154;

assign out_2_fu_481_p3 = ((tmp_25_fu_475_p2[0:0] === 1'b1) ? x_q0 : out_1_reg_154);
...
assign p_shl1_cast_fu_326_p1 = tmp_33_fu_318_p3;

assign p_shl2_cast_fu_338_p1 = tmp_34_fu_330_p3;

assign p_shl_cast_fu_211_p1 = tmp_s_fu_203_p3;

assign r_idx_2_fu_306_p2 = (r_idx_reg_143 + ap_const_lv2_1);

assign r_idx_cast2_fu_296_p1 = r_idx_reg_143;

assign tmp_17_fu_401_p4 = {{out_4_to_int_fu_397_p1[ap_const_lv32_1E : ap_const_lv32_17]}};

assign tmp_19_fu_419_p4 = {{out_1_to_int_fu_415_p1[ap_const_lv32_1E : ap_const_lv32_17]}};

assign tmp_21_fu_445_p2 = (notrhs_fu_439_p2 | notlhs_fu_433_p2);

assign tmp_22_fu_463_p2 = (notrhs7_fu_457_p2 | notlhs6_fu_451_p2);

assign tmp_23_fu_469_p2 = (tmp_21_fu_445_p2 & tmp_22_fu_463_p2);

assign tmp_24_fu_177_opcode = ap_const_lv5_2;

assign tmp_25_fu_475_p2 = (tmp_23_fu_469_p2 & tmp_24_fu_177_p2);

assign tmp_29_fu_215_p2 = (tmp_cast_fu_199_p1 + p_shl_cast_fu_211_p1);

assign tmp_2_fu_221_p2 = (in_c_idx_reg_107 < ap_const_lv4_A? 1'b1: 1'b0);

assign tmp_30_fu_241_p2 = (tmp_29_reg_492 + tmp_3_cast_fu_237_p1);

assign tmp_31_fu_227_p4 = {{in_c_idx_reg_107[ap_const_lv32_3 : ap_const_lv32_1]}};

assign tmp_32_fu_280_p2 = (tmp_42_cast_reg_500 + tmp_4_cast_fu_276_p1);

assign tmp_33_fu_318_p3 = {{tmp_6_fu_312_p2}, {ap_const_lv3_0}};

assign tmp_34_fu_330_p3 = {{tmp_6_fu_312_p2}, {ap_const_lv1_0}};

assign tmp_35_fu_342_p2 = (p_shl2_cast_fu_338_p1 + p_shl1_cast_fu_326_p1);

assign tmp_36_fu_374_p2 = (tmp_35_reg_541 + tmp_9_cast_fu_370_p1);

assign tmp_37_fu_387_p2 = (tmp_49_cast_fu_379_p3 + tmp_4_cast1_reg_518);

assign tmp_38_fu_411_p1 = out_4_to_int_fu_397_p1[22:0];

assign tmp_39_fu_429_p1 = out_1_to_int_fu_415_p1[22:0];

assign tmp_3_cast_fu_237_p1 = tmp_31_fu_227_p4;

assign tmp_42_cast_fu_246_p3 = {{tmp_30_fu_241_p2}, {ap_const_lv4_0}};

assign tmp_43_cast_fu_285_p1 = tmp_32_fu_280_p2;

assign tmp_49_cast_fu_379_p3 = {{tmp_36_fu_374_p2}, {ap_const_lv4_0}};

assign tmp_4_cast1_fu_272_p1 = out_ch_idx_reg_119;

assign tmp_4_cast_fu_276_p1 = out_ch_idx_reg_119;

assign tmp_50_cast_fu_392_p1 = tmp_37_fu_387_p2;
...
assign x_address0 = tmp_50_cast_fu_392_p1;
always @ (posedge ap_clk) begin
    tmp_42_cast_reg_500[3:0] <= 4'b0000;
    tmp_4_cast1_reg_518[11:5] <= 7'b0000000;
    tmp_35_reg_541[0] <= 1'b0;
end
