...
wire  signed [11:0] tmp_114_cast_fu_322_p1;
reg  signed [11:0] tmp_114_cast_reg_688;
...
wire   [13:0] tmp_90_fu_381_p2;
reg   [13:0] tmp_90_reg_706;
...
reg    ap_sig_bdd_134;
wire   [5:0] tmp_92_fu_443_p2;
reg   [5:0] tmp_92_reg_719;
wire   [0:0] exitcond1_fu_386_p2;
wire   [10:0] tmp_95_fu_469_p2;
reg   [10:0] tmp_95_reg_724;
...
wire  signed [63:0] tmp_125_cast_fu_542_p1;
wire   [63:0] tmp_130_cast_fu_587_p1;
wire   [63:0] tmp_119_cast_fu_648_p1;
...
wire   [6:0] tmp_86_fu_304_p3;
wire   [10:0] p_shl_cast_fu_300_p1;
wire   [10:0] p_shl1_cast_fu_312_p1;
wire   [10:0] tmp_87_fu_316_p2;
wire   [11:0] tmp_39_cast_fu_342_p1;
wire   [11:0] tmp_88_fu_346_p2;
wire   [10:0] tmp_68_fu_351_p1;
wire   [12:0] tmp_69_fu_363_p3;
wire   [13:0] p_shl7_cast_fu_355_p3;
wire  signed [13:0] p_shl8_cast_fu_371_p1;
wire   [13:0] tmp_89_fu_375_p2;
wire   [2:0] tmp1_fu_398_p2;
wire  signed [5:0] tmp1_cast_fu_404_p1;
wire   [5:0] slide_in_r_idx_fu_408_p2;
wire   [4:0] tmp_91_fu_431_p3;
wire   [5:0] tmp_42_cast_fu_427_p1;
wire   [5:0] p_shl4_cast_fu_439_p1;
wire   [7:0] tmp_94_fu_457_p3;
wire   [10:0] tmp_93_fu_449_p3;
wire  signed [10:0] p_shl3_cast_fu_465_p1;
wire   [0:0] tmp_70_fu_413_p3;
wire   [0:0] tmp_41_fu_421_p2;
wire   [2:0] tmp2_fu_493_p2;
wire  signed [5:0] tmp2_cast_fu_499_p1;
wire   [5:0] slide_in_c_idx_fu_503_p2;
wire   [0:0] tmp_71_fu_508_p3;
wire   [0:0] tmp_43_fu_516_p2;
wire   [0:0] tmp4_fu_522_p2;
wire  signed [10:0] tmp_44_cast_fu_533_p1;
wire   [10:0] tmp_96_fu_537_p2;
wire   [5:0] tmp_45_cast_fu_547_p1;
wire   [5:0] tmp_97_fu_551_p2;
wire   [6:0] tmp_72_fu_564_p3;
wire   [8:0] p_shl5_cast_fu_556_p3;
wire   [8:0] p_shl6_cast_fu_572_p1;
wire   [8:0] tmp_98_fu_576_p2;
wire   [8:0] tmp_99_fu_582_p2;
wire   [31:0] x_assign_to_int_fu_599_p1;
wire   [7:0] tmp_34_fu_602_p4;
wire   [22:0] tmp_67_fu_612_p1;
wire   [0:0] notrhs_fu_622_p2;
wire   [0:0] notlhs_fu_616_p2;
wire   [0:0] tmp_36_fu_628_p2;
wire   [0:0] tmp_37_fu_246_p2;
wire   [0:0] tmp_38_fu_634_p2;
wire    grp_fu_236_ce;
wire    grp_fu_242_ce;
wire   [4:0] tmp_37_fu_246_opcode;
reg   [19:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (((ap_const_logic_1 == ap_sig_cseq_ST_st6_fsm_5) & (ap_const_lv1_0 == exitcond1_fu_386_p2))) begin
        ...
        tmp_95_reg_724[10 : 2] <= tmp_95_fu_469_p2[10 : 2];
    end
end

always @ (posedge ap_clk) begin
    if (((ap_const_logic_1 == ap_sig_cseq_ST_st3_fsm_2) & (ap_const_lv1_0 == exitcond12_fu_280_p2))) begin
        tmp_114_cast_reg_688[11 : 2] <= tmp_114_cast_fu_322_p1[11 : 2];
    end
end
...
always @ (tmp_46_reg_767 or b_load_reg_777 or ap_sig_cseq_ST_st11_fsm_10 or ap_sig_cseq_ST_st16_fsm_15) begin
    if ((ap_const_logic_1 == ap_sig_cseq_ST_st16_fsm_15)) begin
...
assign W_0_address0 = tmp_130_cast_fu_587_p1;
...
assign notlhs_fu_616_p2 = (tmp_34_fu_602_p4 != ap_const_lv8_FF? 1'b1: 1'b0);

assign notrhs_fu_622_p2 = (tmp_67_fu_612_p1 == ap_const_lv23_0? 1'b1: 1'b0);

assign or_cond5_fu_528_p2 = (tmp4_fu_522_p2 | tmp3_reg_729);

assign out_c_idx_cast_fu_326_p1 = out_c_idx_reg_153;

assign out_feature_address0 = tmp_119_cast_fu_648_p1;

assign out_feature_d0 = ((tmp_38_fu_634_p2[0:0] === 1'b1) ? x_assign_reg_782 : ap_const_lv32_0);

assign out_r_idx_cast_fu_276_p1 = out_r_idx_reg_142;

assign p_shl1_cast_fu_312_p1 = tmp_86_fu_304_p3;

assign p_shl3_cast_fu_465_p1 = $signed(tmp_94_fu_457_p3);

assign p_shl4_cast_fu_439_p1 = tmp_91_fu_431_p3;

assign p_shl5_cast_fu_556_p3 = {{tmp_97_fu_551_p2}, {ap_const_lv3_0}};

assign p_shl6_cast_fu_572_p1 = tmp_72_fu_564_p3;

assign p_shl7_cast_fu_355_p3 = {{tmp_68_fu_351_p1}, {ap_const_lv3_0}};

assign p_shl8_cast_fu_371_p1 = $signed(tmp_69_fu_363_p3);
...
assign tmp3_fu_475_p2 = (tmp_70_fu_413_p3 | tmp_41_fu_421_p2);

assign tmp4_fu_522_p2 = (tmp_71_fu_508_p3 | tmp_43_fu_516_p2);

assign tmp_114_cast_fu_322_p1 = $signed(tmp_87_fu_316_p2);

assign tmp_119_cast_fu_648_p1 = tmp_90_reg_706;

assign tmp_125_cast_fu_542_p1 = $signed(tmp_96_fu_537_p2);

assign tmp_130_cast_fu_587_p1 = tmp_99_fu_582_p2;

assign tmp_34_fu_602_p4 = {{x_assign_to_int_fu_599_p1[ap_const_lv32_1E : ap_const_lv32_17]}};

assign tmp_36_fu_628_p2 = (notrhs_fu_622_p2 | notlhs_fu_616_p2);

assign tmp_37_fu_246_opcode = ap_const_lv5_2;

assign tmp_38_fu_634_p2 = (tmp_36_fu_628_p2 & tmp_37_fu_246_p2);

assign tmp_39_cast_fu_342_p1 = out_c_idx_reg_153;

assign tmp_41_fu_421_p2 = ($signed(slide_in_r_idx_fu_408_p2) > $signed(6'b11011)? 1'b1: 1'b0);

assign tmp_42_cast_fu_427_p1 = r_idx_reg_202;

assign tmp_43_fu_516_p2 = ($signed(slide_in_c_idx_fu_503_p2) > $signed(6'b11011)? 1'b1: 1'b0);

assign tmp_44_cast_fu_533_p1 = $signed(slide_in_c_idx_fu_503_p2);

assign tmp_45_cast_fu_547_p1 = c_idx_reg_225;

assign tmp_67_fu_612_p1 = x_assign_to_int_fu_599_p1[22:0];

assign tmp_68_fu_351_p1 = tmp_88_fu_346_p2[10:0];

assign tmp_69_fu_363_p3 = {{tmp_88_fu_346_p2}, {ap_const_lv1_0}};

assign tmp_70_fu_413_p3 = slide_in_r_idx_fu_408_p2[ap_const_lv32_5];

assign tmp_71_fu_508_p3 = slide_in_c_idx_fu_503_p2[ap_const_lv32_5];

assign tmp_72_fu_564_p3 = {{tmp_97_fu_551_p2}, {ap_const_lv1_0}};

assign tmp_86_fu_304_p3 = {{out_r_idx_reg_142}, {ap_const_lv2_0}};

assign tmp_87_fu_316_p2 = (p_shl_cast_fu_300_p1 - p_shl1_cast_fu_312_p1);

assign tmp_88_fu_346_p2 = ($signed(tmp_114_cast_reg_688) + $signed(tmp_39_cast_fu_342_p1));

assign tmp_89_fu_375_p2 = ($signed(p_shl7_cast_fu_355_p3) - $signed(p_shl8_cast_fu_371_p1));

assign tmp_90_fu_381_p2 = (tmp_89_fu_375_p2 + tmp_cast_reg_665);

assign tmp_91_fu_431_p3 = {{r_idx_reg_202}, {ap_const_lv2_0}};

assign tmp_92_fu_443_p2 = (tmp_42_cast_fu_427_p1 + p_shl4_cast_fu_439_p1);

assign tmp_93_fu_449_p3 = {{slide_in_r_idx_fu_408_p2}, {ap_const_lv5_0}};

assign tmp_94_fu_457_p3 = {{slide_in_r_idx_fu_408_p2}, {ap_const_lv2_0}};

assign tmp_95_fu_469_p2 = ($signed(tmp_93_fu_449_p3) - $signed(p_shl3_cast_fu_465_p1));

assign tmp_96_fu_537_p2 = ($signed(tmp_44_cast_fu_533_p1) + $signed(tmp_95_reg_724));

assign tmp_97_fu_551_p2 = (tmp_45_cast_fu_547_p1 + tmp_92_reg_719);

assign tmp_98_fu_576_p2 = (p_shl5_cast_fu_556_p3 - p_shl6_cast_fu_572_p1);

assign tmp_99_fu_582_p2 = (tmp_cast9_reg_660 + tmp_98_fu_576_p2);
...
assign x_0_address0 = tmp_125_cast_fu_542_p1;
...
always @ (posedge ap_clk) begin
    ...
    tmp_114_cast_reg_688[1:0] <= 2'b00;
    out_c_idx_cast_reg_693[5] <= 1'b0;
    tmp_95_reg_724[1:0] <= 2'b00;
end
