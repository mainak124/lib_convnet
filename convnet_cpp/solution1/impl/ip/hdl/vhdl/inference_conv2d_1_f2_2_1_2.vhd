...
entity inference_conv2d_1_f2_2_1_2_rom is 
    generic(
             dwidth     : integer := 32; 
             awidth     : integer := 4; 
             mem_size    : integer := 16
...
architecture rtl of inference_conv2d_1_f2_2_1_2_rom is 
...
entity inference_conv2d_1_f2_2_1_2 is
    generic (
...
architecture arch of inference_conv2d_1_f2_2_1_2 is
    component inference_conv2d_1_f2_2_1_2_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    inference_conv2d_1_f2_2_1_2_rom_U :  component inference_conv2d_1_f2_2_1_2_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
