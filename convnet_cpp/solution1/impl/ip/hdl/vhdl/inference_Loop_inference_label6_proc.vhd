...
begin
    ...
    ap_sig_bdd_53_assign_proc : process(bias3_TVALID, exitcond_fu_68_p2)
    begin
                ap_sig_bdd_53 <= ((bias3_TVALID = ap_const_logic_0) and (exitcond_fu_68_p2 = ap_const_lv1_0));
    end process;
    ...
    b3_address0 <= tmp_8_fu_80_p1(7 - 1 downto 0);

    -- b3_ce0 assign process. --
    b3_ce0_assign_proc : process(ap_sig_cseq_ST_st2_fsm_1, ap_sig_bdd_53)
    begin
    ...
    b3_we0_assign_proc : process(ap_sig_cseq_ST_st2_fsm_1, exitcond_fu_68_p2, ap_sig_bdd_53)
    begin
    ...
    bias3_TREADY_assign_proc : process(ap_sig_cseq_ST_st2_fsm_1, exitcond_fu_68_p2, ap_sig_bdd_53)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_st2_fsm_1) and (exitcond_fu_68_p2 = ap_const_lv1_0) and not(ap_sig_bdd_53))) then 
