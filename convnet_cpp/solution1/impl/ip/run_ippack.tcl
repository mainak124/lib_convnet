...
set Interfaces {
    ap_clk {
        ...
        buses "inputImage Filter1 bias1 Filter2 bias2 Filter3 bias3 fcWeight fcBias smWeight smBias outputImage outDigit"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
set enable_xo_gen 0
set kernel_files {/home/sakthi/uOpt/lib_convnet/convnet_cpp/inference.cpp /home/sakthi/uOpt/lib_convnet/convnet_cpp/myutils.cpp}
if {$enable_xo_gen} {
